...
import com.tracksure.android.onboarding.BluetoothStatusManager
import com.tracksure.android.onboarding.BatteryOptimizationManager
import com.tracksure.android.onboarding.BatteryOptimizationPreferenceManager
import com.tracksure.android.onboarding.BatteryOptimizationScreen
import com.tracksure.android.onboarding.BatteryOptimizationStatus
import com.tracksure.android.onboarding.InitializationErrorScreen
import com.tracksure.android.onboarding.InitializingScreen
import com.tracksure.android.onboarding.LocationCheckScreen
import com.tracksure.android.onboarding.LocationStatus
import com.tracksure.android.onboarding.LocationStatusManager
import com.tracksure.android.onboarding.OnboardingCoordinator
    ...
    private fun handleNotificationIntent(intent: Intent) {
        ...
        when {
            shouldOpenPrivateChat -> {
                ...
                val senderNickname = intent.getStringExtra(com.tracksure.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.tracksure.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.tracksure.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.tracksure.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.tracksure.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.tracksure.android.geohash.GeohashChannelLevel.REGION
                        else -> com.tracksure.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
