...
import com.tracksure.android.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel) {
    ...
    val displayMessages = when {
        ...
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.tracksure.android.geohash.ChannelID.Location) {
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.tracksure.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.tracksure.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
...
private fun ChatDialogs(
    ...
    if (showDebugSheet) {
        com.tracksure.android.ui.debug.DebugSettingsSheet(
