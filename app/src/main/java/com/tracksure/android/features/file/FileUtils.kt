package com.tracksure.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.tracksure.android.model.TrackSureFilePacket
    ): String {
     ...
     */
    fun messageTypeForMime(mime: String): com.tracksure.android.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.tracksure.android.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.tracksure.android.model.BitchatMessageType.Audio
            else -> com.tracksure.android.model.BitchatMessageType.File
        }
    }
}
