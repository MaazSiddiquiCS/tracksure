...
class ChatViewModel(
    ...
    val selectedLocationChannel: LiveData<com.tracksure.android.geohash.ChannelID?> = state.selectedLocationChannel
    ...
    init {
        ...
        viewModelScope.launch {
            com.tracksure.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.tracksure.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.tracksure.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.tracksure.android.geohash.ChannelID.Mesh) {
        ...
        com.tracksure.android.favorites.FavoritesPersistenceService.initialize(getApplication())


        // Ensure NostrTransport knows our mesh peer ID for embedded packets
        try {
            val nostrTransport = com.tracksure.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.tracksure.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.tracksure.android.nostr.NostrSubscriptionManager
                val identity = com.tracksure.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.tracksure.android.nostr.NostrDirectMessageHandler
    ...
    fun startPrivateChat(peerID: String) {
        ...
        if (success) {
            ...
            try {
                val seen = com.tracksure.android.services.SeenMessageStore.getInstance(getApplication())
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.tracksure.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.tracksure.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.tracksure.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.tracksure.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.tracksure.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.tracksure.android.services.MessageRouter.getInstance(getApplication(), meshService)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.tracksure.android.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.tracksure.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.tracksure.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.tracksure.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.tracksure.android.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.tracksure.android.services.MessageRouter
    ...
    fun panicClearAllData() {
        ...
        try {
            ...
            try {
                val store = com.tracksure.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
    ...
    private fun clearAllCryptographicData() {
        try {
            ...
            try {
                com.tracksure.android.favorites.FavoritesPersistenceService.shared.clearAllFavorites()
    ...
    fun selectLocationChannel(channel: com.tracksure.android.geohash.ChannelID) {
