package com.tracksure.android.noise

import android.content.Context
import android.util.Log
import com.tracksure.android.identity.SecureIdentityStateManager
import com.tracksure.android.mesh.PeerFingerprintManager
import com.tracksure.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.tracksure.android.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.tracksure.android.protocol.BitchatPacket): com.tracksure.android.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.tracksure.android.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
