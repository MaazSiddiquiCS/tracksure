...
import com.tracksure.android.nostr.GeohashMessageHandler
import com.tracksure.android.nostr.GeohashRepository
import com.tracksure.android.nostr.NostrDirectMessageHandler
import com.tracksure.android.nostr.NostrIdentityBridge
import com.tracksure.android.nostr.NostrProtocol
import com.tracksure.android.nostr.NostrRelayManager
import com.tracksure.android.nostr.NostrSubscriptionManager
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.tracksure.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.tracksure.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.tracksure.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.tracksure.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.tracksure.android.model.BitchatMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.tracksure.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.tracksure.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.tracksure.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
            repo.setConversationGeohash(convKey, gh)
            com.tracksure.android.nostr.GeohashConversationRegistry.set(convKey, gh)
        }
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.tracksure.android.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.tracksure.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.tracksure.android.geohash.ChannelID.Mesh -> {
            ...
            is com.tracksure.android.geohash.ChannelID.Location -> {
                ...
                viewModelScope.launch {
                    ...
                    com.tracksure.android.nostr.GeohashAliasRegistry.put("nostr_${dmIdentity.publicKeyHex.take(16)}", dmIdentity.publicKeyHex)
                }
            }
            null -> {
