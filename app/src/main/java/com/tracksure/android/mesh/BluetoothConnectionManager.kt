...
class BluetoothConnectionManager(
    ...
    init {
        ...
        try {
            val dbg = com.tracksure.android.ui.debug.DebugSettingsManager.getInstance()
            // Role enable/disable
    ...
    override fun onPowerModeChanged(newMode: PowerManager.PowerMode) {
        ...
        connectionScope.launch {
            ...
            if (wasUsingDutyCycle != nowUsingDutyCycle) {
                ...
                val clientEnabled = try { com.tracksure.android.ui.debug.DebugSettingsManager.getInstance().gattClientEnabled.value } catch (_: Exception) { true }
                if (clientEnabled) {
            ...
            try {
                val maxServer = com.tracksure.android.ui.debug.DebugSettingsManager.getInstance().maxServerConnections.value
