...
class ChatState {
    ...
    private val _selectedLocationChannel = MutableLiveData<com.tracksure.android.geohash.ChannelID?>(com.tracksure.android.geohash.ChannelID.Mesh)
    val selectedLocationChannel: LiveData<com.tracksure.android.geohash.ChannelID?> = _selectedLocationChannel
    ...
    fun setSelectedLocationChannel(channel: com.tracksure.android.geohash.ChannelID?) {
